...
public class RegistroHuesped extends JFrame {
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(int id, Date fechaEntrada, Date fechaSalida) {
//	public RegistroHuesped(){
		...
		lblTitulo.setBounds(592, 56, 239, 30);
	...
	public void guardarHuesped() {
		...
		String fechaNacimientoString = ((JTextField) txtFechaN.getDateEditor().getUiComponent()).getText();
		String nacionalidad = txtNacionalidad.getSelectedItem().toString();
		String telefono = txtTelefono.getText();
		String idReserva = txtNreserva.getText();

		var huesped = new Huesped(nombre, apellido, Date.valueOf(fechaNacimientoString), nacionalidad, telefono,
				Integer.valueOf(idReserva));
		this.huespedController.guardarHuesped(huesped);
		var exito = new Exito(fechaEntrada, fechaSalida, Integer.valueOf(idReserva), this);

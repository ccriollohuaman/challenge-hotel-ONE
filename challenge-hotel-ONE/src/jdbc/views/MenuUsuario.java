...
public class MenuUsuario extends JFrame {
	 ...
	 */
	public MenuUsuario() {
		this.usuario = Sistema.usuarioAutenticado;
		...
		JPanel btnAdministrador = new JPanel();
		...
		btnAdministrador.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnAdministrador.setBackground(new Color(118, 187, 223));
			}

			@Override
			public void mouseExited(MouseEvent e) {
				btnAdministrador.setBackground(new Color(12, 138, 199));
			}
...
//				dispose();
		...
		btnAdministrador.setBounds(0, 369, 257, 56);
		btnAdministrador.setBackground(new Color(12, 138, 199));
		...
		lblAdministrador.setBounds(27, 11, 200, 34);
		btnAdministrador.add(lblAdministrador);
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int opcion = JOptionPane.showOptionDialog(null,
						"<html><div style='text-align: center;'>¿Estas seguro que quieres cerrar la sesión?</div></html>",
